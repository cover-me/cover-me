...
**qtplotter**: Try to fit [Rubenknex/qtplot](https://github.com/Rubenknex/qtplot) into Jupyter Notebook and Python 3. It drops features of realtime visualization/fast navigation and focuses on publication quality and efficiency. I guess I need to study the license before pushing this project too far away.
